...
<div class="hero-image">
  ...
  <div class="hero-small">
    ...
    across 185 countries and five major crops.
  </div>
...
<div class="card-row">
  ...
  <div class="exec-card card-orange">
    <div>📊</div><div class="num">{n_hotspot_countries}</div>
    <div class="lbl">High-Pressure Countries</div>
    <div class="cap">Identified across the five focus crops using both thresholds.</div>
  </div>
